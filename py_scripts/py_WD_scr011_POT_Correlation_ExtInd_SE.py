...
ID_Dir  = (Data.loc[Data.index, 'Thetap'] >= 45) & (Data.loc[Data.index, 'Thetap'] < 155)
# ID_Dir  = (Data.loc[Data.index, 'Thetap'] >= 155) & (Data.loc[Data.index, 'Thetap'] < 270)
...
font_name = 'Calibri'
font_size = 12
caxis_rho = (0, 0.5)  # Color axis limits for Kendall correlation
...
sns.heatmap(rho_Kendall, xticklabels=DecTime, yticklabels=Thr, cmap='Reds', 
...
# %% Save results
data_thr.to_csv('Data/Falsterbo_00_South_Wave10958_WD_POT_SE_RH2000.csv')
