...
params_wl = gumbel_r.fit(Wl) 

#-- Fitting the best copula family 
copFLOOD_T = pv.Bicop( pv.BicopFamily.joe, rotation = 0)
...
FLOODfv_Tsim =  gumbel_r.ppf(FLOOD_Tsim[:,1], *params_wl)
...
# Uncomment to save
df_and.to_csv("Data/Falsterbo_03_South_BivRP_WD_AND_SE_RH2000.csv", index=False)
df_or.to_csv("Data/Falsterbo_04_South_BivRP_WD_OR_SE_RH2000.csv", index=False)
